<?php headerAdmin("Pacientes"); ?>
<main class="app-content">
	<div class="app-title">
		<div>
			<h1>
			<i class="fa fa-wheelchair" aria-hidden="true"></i> Pacientes 
				<button class="btn btn-primary" type="button" onclick="setModal('modalFormPacienteNuevo','show')">
