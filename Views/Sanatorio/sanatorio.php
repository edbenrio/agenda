<?php headerAdmin("Sanatorios"); ?>
<main class="app-content">
	<div class="app-title">
		<div>
			<h1>
				<i class="fa fa-hospital-o" aria-hidden="true"></i> Sanatorios <button class="btn btn-primary" type="button" onclick="setModal('modalFormSanatorioNuevo','show')"><i class="fa fa-plus-circle"></i> Nuevo</button>
			</h1>
